...
def eat(score):
    ...
    num2 = WIDTH//30
    if 0 < player_x < 1070:
        if level[p_center_y // num1][p_center_x // num2] == 1:
            level[p_center_y // num1][p_center_x // num2] = 0
            score += 10
        if level[p_center_y // num1][p_center_x // num2] == 2:
            level[p_center_y // num1][p_center_x // num2] = 0
            score += 50
...
# print(startPos)
player_x = startPos[0] #460
player_y = startPos[1] #682
# player_x = 460
# player_y = 682
ghost1_x = 0#460
ghost1_y = 0#130
...
while run:    
    timer.tick(fps)
    print(make_pos((player_x,player_y)))
    ...
    draw_ghost()
    draw_misc()
    p_center_x = player_x + 19
    p_center_y = player_y + 19
    turns_allowed = check_position(p_center_x,p_center_y)
